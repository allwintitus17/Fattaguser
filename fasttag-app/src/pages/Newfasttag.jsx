...
//   // Track if we should save to database (only after payment)
//   const [shouldSaveToDb, setShouldSaveToDb] = useState(false);

//   // Handle personal success/error - ONLY when we want to save
//   useEffect(() => {
//     if (shouldSaveToDb) {
//       if (personalError) {
...
//         setCreatedPersonalDetailsId(personalDetails._id);
//         dispatch(resetPersonal());
//       }
//     }
//   }, [personalError, personalSuccess, personalMessage, personalDetails, dispatch, shouldSaveToDb]);

//   // Handle vehicle success/error - ONLY when we want to save
//   useEffect(() => {
//     if (shouldSaveToDb) {
//       if (vehicleError) {
...
//         setCreatedVehicleId(vehicle._id);
//         dispatch(resetVehicle());
//         setDbSaveCompleted(true);
//         setShouldSaveToDb(false);
//       }
//     }
//   }, [vehicleError, vehicleSuccess, vehicleMessage, vehicle, dispatch, shouldSaveToDb]);

//   // Handle payment success/error and trigger DB saves
//   useEffect(() => {
//     if (paymentError) {
...
//       // Enable database saving and then save data
//       setShouldSaveToDb(true);
//       saveDataToDatabase();
//     }
//   }, [paymentError, paymentMessage, paymentStatus, dispatch]);

//   // Function to save data to database after payment success
//   const saveDataToDatabase = async () => {
//     toast.info('Saving your details to database...');
...
//   // Update payment with created IDs after both personal and vehicle are saved
//   const updatePaymentWithIds = async () => {
//     if (createdVehicleId && createdPersonalDetailsId && currentPayment) {
//       console.log('Updating payment with IDs:', {
//         paymentId: currentPayment._id,
//         vehicleId: createdVehicleId,
//         personalDetailsId: createdPersonalDetailsId
//       });
      
//       // Update the payment record with the new IDs using Redux
...
//   useEffect(() => {
//     if (dbSaveCompleted && paymentCompleted && createdVehicleId && createdPersonalDetailsId) {
//       // Update payment with the new IDs
//       updatePaymentWithIds();
      
//       toast.success('FastTag application completed successfully!');
//       setTimeout(() => {
//         navigate('/mytag');
//       }, 2000);
//     }
//   }, [dbSaveCompleted, paymentCompleted, createdVehicleId, createdPersonalDetailsId, navigate]);

//   // Redirect after both personal and vehicle data are saved
//   useEffect(() => {
//     if (dbSaveCompleted && paymentCompleted && createdVehicleId && createdPersonalDetailsId) {
//       toast.success('FastTag application completed successfully!');
//       setTimeout(() => {
...
//   // Personal details form submission - NO DB SAVE YET
...
//     // Only validate and store locally, don't save to DB yet
//     setPersonalDataValidated(true);     
//     toast.success('Personal details saved locally - will be sent to database after payment');     
//     setCurrentStep(2);   
//   };    

//   // Vehicle details form submission - NO DB SAVE YET
...
//     toast.success('Vehicle details saved locally - will be sent to database after payment');              
    
//     // Move to payment step
//     setCurrentStep(3);   
//   };    

//   // Payment submission - opens UPI modal with payment creation
...
//     // Create payment record first (without vehicleId/personalDetailsId since they don't exist yet)
//     const paymentData = {
//       paymentFlag: 0, // New FastTag
//       amount: parseFloat(amount),
//       // Don't include vehicleId and personalDetailsId yet - we'll add them after successful payment
//       vehicleInfo: {
//         registrationNumber: vehicleData.registrationNumber,
//         vehicleType: vehicleData.vehicleType,
//         model: vehicleData.model,
...
//       personalInfo: {
//         fullName: personalData.fullName,
//         phoneNumber: user.mobile || user.phone || '0000000000', // Use user's phone or default
//         email: user.email,
//         panNumber: personalData.panNumber,
//         aadharNumber: personalData.aadharNumber
//       },
...
//             Fill your personal details (will be saved after payment)           
//           </p>           
...
//           <p style={{ color: '#666', marginBottom: '1rem' }}>             
//             Fill all vehicle details (will be saved after payment)           
//           </p>           
...
//                 fontSize: '0.9rem'
//               }}>
//                 Your personal and vehicle details will be saved to the database only after successful payment completion.
//               </p>
//             </div>
...
//                     fontWeight: '600'
//                   }}
//                   disabled={!personalDataValidated || !vehicleDataValidated}
//                 >
...
//                 textAlign: 'center'
//               }}>
//                 Secure UPI payment gateway - Details saved after payment
//               </small>
//             </div>
//           </form>
...
//         user={user}
//         vehicleId={null} // We don't have these IDs yet
//         personalDetailsId={null} // We don't have these IDs yet
//         // The payment will be created when the modal opens
//       />
...
//             {dbSaveCompleted ? 'FastTag Application Completed!' : 'Payment Successful! Saving details...'}
//           </h3>
//           <p style={{ color: '#155724', marginBottom: '1rem' }}>
//             {dbSaveCompleted ? 'Redirecting to My Tags page...' : 'Please wait while we save your details to database...'}
//           </p>
//           <div style={{
//             width: '100%',
//             height: '4px',
